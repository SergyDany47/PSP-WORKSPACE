package com.uem.restTemplateConcesionario.proxy;
...
import com.uem.restTemplateConcesionario.entidad.Coche;

public class Proxy {

	public static final String URL_CONCESIONARIO = "http://localhost:8080/restconcesionariocoches/";
